<template>
  <div class="app-container">
    ...
    <el-table v-loading="loading" :data="procurementList" @selection-change="handleSelectionChange">
      ...
      <el-table-column label="采购编号" align="center" prop="procurementId" />
      ...
      <el-table-column label="操作" align="center" class-name="small-padding fixed-width">
        <template slot-scope="scope">
          <el-button
            ...
            v-hasPermi="['yzt:procurement:warehouse']"
          >入库</el-button>
        </template>
      </el-table-column>
    </el-table>
    ...
    <el-dialog :title="title" :visible.sync="open" width="600px" append-to-body>
      <el-form ref="form" :model="form" :rules="rules" label-width="100px">
        <el-form-item label="送货单号" prop="oddNumbers">
          <el-input v-model="form.oddNumbers" placeholder="请输入送货单号" />
        </el-form-item>
        <el-form-item label="入库量" prop="receipt">
          <el-input v-model="form.number" placeholder="请输入入库量" />
        </el-form-item>
        <el-form-item label="到货日期" prop="deliveryTime">
...
<script>
import { listProcurement, getProcurement, delProcurement, addProcurement, updateProcurement, exportProcurement, warehouseProcurement } from "@/api/yzt/procurement";
      ...
      this.$refs["form"].validate(valid => {
        if (valid) {
          if (this.form.procurementId != null) {
            warehouseProcurement(this.form).then(response => {
